...
Copy the ahk.cfg to your joy2key installation, and select it in Joy2key.

Run the savestatemanager.ahk from anywhere to start the script.
...
### Save Folder:
![Save folder](https://raw.github.com/Bhane/Savestate-Manager/master/readme/savefolder.png)
### Save Sub-Folder:
![Save sub-folder](https://raw.github.com/Bhane/Savestate-Manager/master/readme/savesubfolder.png)
